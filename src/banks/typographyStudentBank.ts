    ...
    multipleChoice: [
        {
            ...
            answer: 0,
            aiResponses: [
                "Correct! Typography is the design and use of typefaces [Typography, pg. 6].",
        ...
        },
        {
            ...
            aiResponses: [
                ...
                "Correct! Sans serif typefaces are recommended for short large text such as titles and headings [Typography, pg. 16].",
        ...
        },
        {
            ...
            aiResponses: [
                ...
                "Correct! Leading is the distance between the baselines of adjacent lines of text [Typography, pg. 19].",
    ...
    freeResponse: [
        {
            ...
            aiResponse: "A strong answer notes that typography should support readability and legibility, create a visual hierarchy, and reinforce or add meaning to the content [Typography, pg. 8]."
        },
        {
            type: "free-response",
            ...
            aiResponse: "A good answer explains that Roboto was designed to improve legibility of dense text on small screens and to provide a modern, consistent appearance across Google products [Typography, pg. 24]."
        },
        {
            type: "free-response",
            ...
            aiResponse: "An effective response mentions typographic goals (legibility, readability, meaning), the nature of the content (code, chat, reports), the context (mobile, driving, lecture room), the medium (online, print, TV), and the intended audience [Typography, pg. 22]."
        }
    ],
    ...
    trueFalse: [
        {
            ...
            answer: "true",
            aiResponse: "True. The slides define monospaced fonts as giving each character the same width [Typography, pg. 18]."
        },
        {
            type: "true-false",
            question: "According to the lecture, there is a single best typeface that works in all situations.",
            answer: "false",
            aiResponse: "False. The lecture emphasizes that there are hundreds of typefaces and no single best choice; it depends on goals, content, context, and audience [Typography, pg. 34]."
        },
        {
            type: "true-false",
            question: "Highway signs in the U.S. use a special typeface designed to maximize legibility at a distance.",
            answer: "true",
            aiResponse: "True. The slides mention the FHA’s 'Highway Gothic' typeface for road signage to maximize legibility [Typography, pg. 32]."
        }
    ],
    ...
    sentenceCompletion: [
        {
            ...
            answer: "text",
            aiResponse: "Typography is called the user interface of text [Typography, pg. 38]."
        },
        {
            type: "sentence-completion",
            question: "In mobile apps, body text is recommended at a minimum of ________sp.",
            answer: "16",
            aiResponse: "The lecture suggests body text should be at least 16sp [Typography, pg. 14]."
        },
        {
            type: "sentence-completion",
            question: "The distance between baselines of two adjacent lines of text is called ________.",
            answer: "leading",
            aiResponse: "That spacing is known as leading [Typography, pg. 19]."
        }
    ],
    ...
    selection: [
        {
            ...
            answers: [0, 1, 2, 4],
            aiResponses: [
                "✅ Baseline is one of the key attributes [Typography, pg. 15].",
                "✅ Ascent and descent are mentioned as vertical metrics [Typography, pg. 15].",
                "✅ X-height is discussed and illustrated [Typography, pg. 15].",
                "❌ Parallax is not a typographic attribute here.",
                "✅ Weight (light/bold) is part of type attributes [Typography, pg. 15]."
            ]
        },
        {
            type: "select-all",
            ...
            answers: [0, 1, 2, 4],
            aiResponses: [
                "✅ Maps use Roboto to maximize legibility on small screens [Typography, pg. 24].",
                "✅ Source code editors like Android Studio use monospaced fonts such as Consolas [Typography, pg. 28].",
                "✅ Highway signs use Highway Gothic for legibility at a distance [Typography, pg. 32].",
                "❌ Historical newspaper ads are not used as an example.",
                "✅ Auto UIs (e.g., Android Auto) use large sans serif text for glanceability [Typography, pg. 25]."
            ]
        },
        {
            type: "select-all",
            ...
            answers: [0, 1, 3],
            aiResponses: [
                "✅ The slides recommend using system typefaces such as Roboto [Typography, pg. 14].",
                "✅ High text–background contrast is encouraged [Typography, pg. 14].",
                "❌ Headings should be at most 2–3 lines, not extremely long.",
                "✅ A minimum of 16sp is suggested for body text [Typography, pg. 14].",
